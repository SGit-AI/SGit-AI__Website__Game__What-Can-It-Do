...
> read.record.history: which products grant it, what stands in the way, what narrows it, and who wants it.

*Source: <https://what-can-it-do.games.sgit.ai/map/capabilities/read.record.history/index.html> · site v0.4.1 · this file is generated from the same content
as the page, so the two cannot drift. Every page on this site has a `.md` twin; internal links
below point at them.*

---

[Play](../../../index.md) / [The map](../../../map/index.md) / [The capabilities](../../../map/capabilities/index.md) / Read a retained record: shell history, past sessions

# Read a retained record: shell history, past sessions

`read.record.history` — **read** × **record** at **host** reach (the machine, container or account it runs as). Family: filesystem. Effect: **cannot be undone**.
...
**The setting:** history off, or a fresh environment per task, so the grant is a tree over the present rather than a union over every prior turn

**What it costs:** the agent forgets between tasks
...
*[Site index for agents](../../../llms.txt) · [HTML version](https://what-can-it-do.games.sgit.ai/map/capabilities/read.record.history/index.html)*
